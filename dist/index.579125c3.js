document.addEventListener("DOMContentLoaded", ()=>{
    class Gallery {
        ...
        listeners() {
            ...
            this.items.forEach((item)=>{
                ...
                item.addEventListener("click", (event)=>{
                    if (!item.classList.contains("--open")) this.openItems(item.dataset.index);
                    else this.closeItems();
                });
            });
            ...
            window.addEventListener("touchmove", (event)=>{
                ...
                if (vector) range = this.currentY - y;
                else range = y - this.currentY;
            ...
            window.addEventListener("wheel", (event)=>{
                ...
                for(let i = 0; i < this.columns; i++){
                    ...
                    else this.moveItems(+type + sibling, vector, step * this.wheelMod);
                }
            });
        }
        openItems(index) {
        ...
        setItemsWidth(index = null) {
            ...
            if (index) this.items.forEach((item)=>{
        ...
        setItemsPosition(index = null) {
            ...
            this.items.forEach((item)=>{
                ...
                if (index && item.dataset.index == index) {
                    ...
                    height != this.heightOpenedItem && (this.heightOpenedItem = height);
        ...
        setActiveItems(index) {
            this.items.forEach((item)=>{
                item.dataset.index == index ? item.classList.add("--active") : item.classList.remove("--active");
            });
        }
        checkScreen() {
